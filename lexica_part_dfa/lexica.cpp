...
// Updated tokens and keywords to match main.cpp grammar
#define TOKENS_RE         ";|:\\>|eg|ne|<=|>=|\\+|-|\\*|/|%|\\||!|,|:|\\[|\\]|\\(|\\)|\\{|\\}|[_a-z0-9]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|:\\>|eg|ne|<=|>=|\\+|-|\\*|/|%|\\||!|,|:|\\[|\\]|\\(|\\)|\\{|\\}|program|data|start|finish|get|put|if|else|for|to|downto|do|while|and|int16_t"
...
void prepareKeyWordIdGetter(char* keywords_, char* keywords_re) {
	...
	for (char* keywords_re_ = keywords_re, *keywords__ = keywords_; (*keywords_re_ != '\0') ? 1 : (*keywords__ = '\0', 0); (*keywords_re_ != '\\' || (keywords_re_[1] != '+' && keywords_re_[1] != '*' && keywords_re_[1] != '|' && keywords_re_[1] != '>')) ? *keywords__++ = *keywords_re_ : 0, ++keywords_re_);
}
